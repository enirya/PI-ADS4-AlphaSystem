...
public class CarrinhoAdapter extends ArrayAdapter<Produto> {
    ...
    public CarrinhoAdapter(@NonNull Context context, /*@LayoutRes*/ ArrayList<Produto> list) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(listItem == null)
            listItem = LayoutInflater.from(mContext).inflate(R.layout.activity_item_view_cart,parent,false);

        Produto currentProduto = listaCarrinho.get(position);
